...
void welcome_window()
{
	...
	bitmap_output(-1.25, 1.8, 0.50, "!! COMPUTER GRAPHICS PROJECT !!");
	bitmap_output(-0.6, 1.6, 0.50, "BY : JIJASH || PRASIDDHI || PRESISSSSSS ");
...
void operations_window()
{
	...
	bitmap_output(-1.25, -1.0, 0.50, "11.PLEASE PRESS C TO CONTINUE");
	glutSwapBuffers();
	glFlush();
}
